...
class AssertWebposCheckoutAddOrderNote extends AbstractConstraint
{
    public function processAssert(WebposIndex $webposIndex)
    {
        ...
        \PHPUnit_Framework_Assert::assertTrue(
            ...
            'On the Products List Page - The action SAVE ORDER NOTE on the popup add order note of the web POS Cart was not visible.'
        );
        \PHPUnit_Framework_Assert::assertTrue(
            $webposIndex->getCheckoutNoteOrder()->getTextArea()->isVisible(),
            'On the Products List Page - The TEXT AREA on the popup add order note of the web POS Cart was not visible.'
        );
    }
