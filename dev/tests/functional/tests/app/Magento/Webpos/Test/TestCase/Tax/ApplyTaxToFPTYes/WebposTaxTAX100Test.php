...
use Magento\Webpos\Test\Constraint\Tax\AssertTaxAmountOnOrderHistoryInvoiceWithTaxApplyToFPT;
use Magento\Webpos\Test\Page\WebposIndex;

/**
 * Setting: Setting: [Apply Tax To FPT] = Yes
 * Testcase TAX100 - Check tax amount on cart page and Checkout page
 *
 * Precondition
 * In backend:
 ...
 * Acceptance Criteria
 * 4.
 * Tax amount of whole order = [product_price_excl_tax] * [tax_rate] + [fixed_product_tax] * [tax_rate]
 * 5. Invoice order successfully
 *
 *
 * Class WebposTaxTAX100Test
 * @package Magento\Webpos\Test\TestCase\Tax\ApplyTaxToFPTYes
 */
class WebposTaxTAX100Test extends Injectable
{
    /**
     * @var WebposIndex
     */
    ...
    /**
     * @var AssertTaxAmountOnOrderHistoryInvoiceWithTaxApplyToFPT
     */
    protected $assertTaxAmountOnOrderHistoryInvoiceWithTaxApplyToFPT;
    ...
    public function __inject(
        ...
        AssertTaxAmountOnOrderHistoryInvoiceWithTaxApplyToFPT $assertTaxAmountOnOrderHistoryInvoiceWithTaxApplyToFPT
    )
    {
        $this->webposIndex = $webposIndex;
        $this->fixtureFactory = $fixtureFactory;
        $this->assertWebposCheckoutPagePlaceOrderPageSuccessVisible = $assertWebposCheckoutPagePlaceOrderPageSuccessVisible;
        $this->assertTaxAmountOnOrderHistoryInvoiceWithTaxApplyToFPT = $assertTaxAmountOnOrderHistoryInvoiceWithTaxApplyToFPT;
    }
