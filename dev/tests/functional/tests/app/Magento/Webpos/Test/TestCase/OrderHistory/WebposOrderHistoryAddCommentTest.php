...
class WebposOrderHistoryAddCommentTest extends Injectable
{
	/**
	 * @var WebposIndex
	 */
	...
	)
	{
		...
		self::assertTrue(
			$this->webposIndex->getOrdersHistory()->getAction($addCommentText)->isVisible(),
			'Order History - Add Comment - Add Comment Action is missed'
		);

		$this->webposIndex->getOrdersHistory()->getAction($addCommentText)->click();
