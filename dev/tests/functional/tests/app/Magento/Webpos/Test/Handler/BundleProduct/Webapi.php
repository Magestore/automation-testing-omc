...
namespace Magento\Webpos\Test\Handler\BundleProduct;
 ...
 */
class Webapi extends SimpleProductWebapi implements WebposBundleProductInterface
{
    /**
     * @constructor
