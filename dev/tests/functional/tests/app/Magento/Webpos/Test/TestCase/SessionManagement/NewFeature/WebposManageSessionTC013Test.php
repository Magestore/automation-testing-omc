 ...
 * Testcase - TC0013 Check showing session all history
 *
 * Precondition
 * Loged into backend
 ...
 *
 * Acceptance
 * Show the sessions in all
 *
 *
 * Class WebposManageSessionTC013
 * @package Magento\Webpos\Test\TestCase\SessionManagement\NewFeature
 */
class WebposManageSessionTC013Test extends Injectable
{
    /**
     * Pos Index Page
     *
    ...
    public function __prepare()
    {
        $this->objectManager->getInstance()->create(
            ...
            create_show_all_history_conducted']
        )->run();
    }
