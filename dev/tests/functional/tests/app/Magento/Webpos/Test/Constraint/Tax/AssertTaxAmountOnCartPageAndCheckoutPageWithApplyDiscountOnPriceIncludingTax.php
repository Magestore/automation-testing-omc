...
class AssertTaxAmountOnCartPageAndCheckoutPageWithApplyDiscountOnPriceIncludingTax extends AbstractConstraint
{
    public function processAssert(WebposIndex $webposIndex, $products, $taxRate, $discountAmount)
    {
        ...
        $discountValue = round($productPriceExcludeTax * (1 + $taxRate / 100) * $discountAmount / 100, 2);
