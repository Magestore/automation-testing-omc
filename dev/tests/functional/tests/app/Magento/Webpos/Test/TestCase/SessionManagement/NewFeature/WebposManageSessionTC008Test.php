 ...
 * Testcase - TC0008 Check showing session history in last 15 days
 *
 * Precondition
 * Loged into backend
 ...
 *
 * Steps
 * 1. In webpos settings, set config the field: Limit days to show session history = last 15 days
 * 2. Login webpos with staff account
 * 3. Go to Session Management page
 * 4. Observe the sessions listed on
 *
 * Acceptance
 * Show the sessions in last 15 days
 *
 *
 * Class WebposManageSessionTC008
 * @package Magento\Webpos\Test\TestCase\SessionManagement\NewFeature
 */
class WebposManageSessionTC008Test extends Injectable
{
    /**
     * Pos Index Page
     *
    ...
    public function __prepare()
    {
        $this->objectManager->getInstance()->create(
            ...
            create_show_history_conducted_within_15_day']
        )->run();
    }
