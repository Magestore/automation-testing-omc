...
/**
 * Manage POS - Edit POS
 * Testcase MP37 - Check [Delete] button
 *
 * Precondition
 ...
 * 4. Click on [x] button on the confirmation popup
 *
 * Acceptance
 ...
 *
 *
 * Class WebposManagePosMP37
 * @package Magento\Webpos\Test\TestCase\Pos\Edit
 */
class WebposManagePosMP37Test extends Injectable
{
    /**
     * Pos Index Page
     *
    ...
    public function test()
    {
        ...
        $this->posNews->getPosForm()->closePopupModal();
