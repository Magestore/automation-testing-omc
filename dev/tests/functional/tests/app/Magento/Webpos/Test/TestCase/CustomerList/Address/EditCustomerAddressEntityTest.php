...
/**
 * Class EditCustomerAddressEntityTest
 * @package Magento\Webpos\Test\TestCase\CustomerList
 */
class EditCustomerAddressEntityTest extends Injectable
{
    /**
     * Webpos Index page.
     *
    ...
    public function test(Staff $staff, $emailInitial, $company, $phone, $street1, $street2, $city, $zipCode, $country, $province, $vat)
    {
        ...
        sleep(2);
        $this->webposIndex->getCustomerListContainer()->editCustomerAddress()->click();
