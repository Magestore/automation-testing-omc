...
/**
 * Class AssertWebposClosePopupOrderNote
 * @package Magento\Webpos\Test\Constraint\Checkout\CartPageActionMenu
 */
class AssertWebposClosePopupOrderNote extends AbstractConstraint
{
    public function processAssert(WebposIndex $webposIndex)
    {
        ...
        $webposIndex->getCheckoutNoteOrder()->getCloseOrderNoteButton()->click();
