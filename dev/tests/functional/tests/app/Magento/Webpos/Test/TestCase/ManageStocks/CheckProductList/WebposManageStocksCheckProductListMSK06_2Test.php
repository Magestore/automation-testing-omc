 ...
 *
 * Steps
 * 1. Search 1 product belong to warehouse A  by Product name
 *
 * Acceptance Criteria
 * 1. The grid shows products that has SKU matches or contains keyword with corresponding to qty
 *
 * Class WebposManageStocksCheckProductListMSK06_2Test
