...
/**
 * Class WebposCustomerSearchByPhoneNumberCC30Test
 ...
 *
 * Steps:
 * "1. Enter correct Customer phone number on Search box
 ...
 *
 */
class WebposCustomerSearchByPhoneNumberCC30Test extends Injectable
{
    /**
     * @var WebposIndex
     */
    ...
    public function test()
    {
        ...
        $this->webposIndex->getCheckoutChangeCustomer()->search($customer->getAddress()[0]['telephone']);
        sleep(1);
        ...
        $this->assertTrue(
            ...
            'Customer with telephone: ' . $customer->getAddress()[0]['telephone'] . ' is not visible.'
        );
