...
/**
 * @Author: thomas
 * @Created At:   2017-09-21 08:28:27
 * @Email:  thomas@trueplus.vn
 * @Last Modified by:   Thomas
 * @Last Modified time: 2017-11-02 16:00:16
...
class SaveBlankRegisterShiftTest extends Injectable
{
    /**
     * Webpos Index page.
     *
    ...
    public function test(Staff $staff)
    {
        ...
        sleep(3);
        $this->webposIndex->getRegisterShift()->addBlankRegisterShift();
    }
}
