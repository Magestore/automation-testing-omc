 ...
 * Testcase TAX35 - Check tax amount on Checkout page
 *
 * Precondition:
 * In backend:
 ...
 *
 * Acceptance Criteria
 * 3. Tax amount = (Subtotal + shipping fee) x Tax rate
 *
 * Class WebposTaxTAX35Test
 * @package Magento\Webpos\Test\TestCase\Tax\TaxClassForShippingTaxableGoodsAndShippingExcludingTax
 */
class WebposTaxTAX35Test extends Injectable
{
    /**
     * @var WebposIndex
     */
