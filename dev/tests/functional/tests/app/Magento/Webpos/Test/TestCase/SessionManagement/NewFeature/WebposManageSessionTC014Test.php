 ...
 *
 *
 * Class WebposManageSessionTC014
 * @package Magento\Webpos\Test\TestCase\SessionManagement\NewFeature
 */
class WebposManageSessionTC014Test extends Injectable
{
    /**
     * Pos Index Page
     *
    ...
    public function __inject()
    {
        ...
        $this->objectManager->getInstance()->create(
            ...
            ['configData' => 'create_section_before_working_yes,config_no_send_confirm_order']
        )->run();
...
//        login
        ...
        $webposIndex->getMsWebpos()->waitForElementVisible('#webpos_cart');
        $webposIndex->getMsWebpos()->waitForElementVisible('#webpos_checkout');
