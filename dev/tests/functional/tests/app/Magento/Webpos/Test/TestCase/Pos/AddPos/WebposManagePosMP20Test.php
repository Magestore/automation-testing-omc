...
/**
 * Manage POS - Add POS
 * Testcase MP20 - Create a POS with checking [Available for Other Staff] field
 *
 * Precondition
 ...
 * 5. The created POS (Pos test 2) will be shown and selected on [POS] field
 *
 * Class WebposManagePosMP20
 * @package Magento\Webpos\Test\TestCase\Pos\Filter
 */
class WebposManagePosMP20Test extends Injectable
{
    /**
     * Pos Index Page
     *
