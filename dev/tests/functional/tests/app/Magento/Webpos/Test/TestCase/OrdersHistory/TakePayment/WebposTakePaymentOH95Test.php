...
/**
 * Class WebposTakePaymentOH95Test
 ...
 * 2. Take payment
 * 3. Select a payment method  > fill amount less than remain amount > Submit > OK
 *
 * Acceptance Criteria:
 ...
 * 4. [Take payment] button is still shown
 * 5. Order status is changeless
 */
class WebposTakePaymentOH95Test extends Injectable
{
    /**
    ...
    public function test($products, FixtureFactory $fixtureFactory, $configData, $amount)
    {
        ...
        \PHPUnit_Framework_Assert::assertTrue(
            $this->webposIndex->getOrderHistoryPayment()->isVisible(),
            'Visible popup take payment'
        );
        sleep(1);
        self::assertTrue(
            $this->webposIndex->getOrderHistoryPayment()->getPaymentMethod('Web POS - Cash In')->isVisible(),
            'Payment method didn\'t display'
        );
