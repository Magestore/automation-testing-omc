...
class WebposCreateMultiOrderAndThenLogInByOtherStaffCP28Test extends Injectable
{
    ...
    public function test(Staff $staff, ConfigData $dataConfig, ConfigData $dataConfigToNo)
    {
        ...
        sleep(1);
        $this->webposIndex->getCMenu()->getSessionManagement()->click();
        sleep(1);
        $this->webposIndex->getShiftContainer()->getButtonEndSession()->click();
        sleep(1);
        $this->webposIndex->getCloseShiftContainer()->getConfirmSession()->click();
        sleep(1);
        $this->webposIndex->getModal()->getOkButton()->click();
        sleep(1);
        $this->webposIndex->getSetClosingBalanceReason()->getButtonBtnDone()->click();
        sleep(1);
        $this->webposIndex->getMsWebpos()->clickCMenuButton();
        sleep(1);
