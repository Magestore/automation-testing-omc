...
/**
 * @Author: thomas
 * @Created At:   2017-09-21 08:50:09
 * @Email:  thomas@trueplus.vn
 * @Last Modified by:   Thomas
 * @Last Modified time: 2017-11-02 15:59:58
...
class MakeAdjustmentRegisterShiftTest extends Injectable
{
    /**
     * Webpos Index page.
     *
    ...
    public function test(Staff $staff)
    {
        ...
        $this->webposIndex->getRegisterShift()->doneMakeAdjustment();
    }
}
