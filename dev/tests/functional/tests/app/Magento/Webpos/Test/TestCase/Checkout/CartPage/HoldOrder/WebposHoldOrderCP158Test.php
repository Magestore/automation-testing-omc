...
/**
 * Class WebposHoldOrderCP158Test
 ...
 *
 * Acceptance:
 * 1. Order will be loaded to cart page with correct  products  then auto next to checkout page.
 *
 */
class WebposHoldOrderCP158Test extends Injectable
{
    /**
     * @var WebposIndex
     */
