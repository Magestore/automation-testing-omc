...
namespace Magento\Giftvoucher\Test\Handler\GiftProduct;
 ...
 */
class Curl extends AbstractCurl implements CatalogProductGiftVoucherInterface
{
    /**
     * Fixture instance.
     *
    ...
    protected $mappingData = [
        ...
        'gift_price_type' => [
            'Same as Gift Card Value' => 1,
            'Fixed Price' => 2,
            'Percent of Gift Card value' => 3
        ]
    ];
