 ...
 */
class AssertCreditProductInCategory extends AbstractConstraint
{
    /**
     * Checking the product in the page of its price.
     *
    ...
    public function processAssert(
        ...
        \PHPUnit_Framework_Assert::assertTrue(
            $isProductVisible,
            'Credit Product is absent on category page.'
        );
    }
    ...
    {
        return 'Credit Product is visible in category page.';
    }
}
