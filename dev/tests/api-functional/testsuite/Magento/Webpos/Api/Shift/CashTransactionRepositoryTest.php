...
class CashTransactionRepositoryTest extends WebapiAbstract
{
    ...
    /**
     * @var \Magento\Webpos\Api\Shift\ShiftRepositoryTest
     */
    protected $openSession;

    /**
     * @var \Magento\Webpos\Api\Shift\Constraint\CashTransactionRepository
     */
    protected $cashTransactionRepository;

    protected function setUp()
    {
        $this->openSession = Bootstrap::getObjectManager()->get('\Magento\Webpos\Api\Shift\ShiftRepositoryTest');
        $this->cashTransactionRepository = Bootstrap::getObjectManager()->get('\Magento\Webpos\Api\Shift\Constraint\CashTransactionRepository');
    }
    /**
