...
class CreditmemoRepositoryTest extends WebapiAbstract
{
    ...
    /**
     * @var \Magento\Webpos\Api\Sales\Constraint\CreditmemoRepository
     */
    protected $creditmemoRepository;

    protected function setUp()
    {
        $this->creditmemoRepository = Bootstrap::getObjectManager()->get('\Magento\Webpos\Api\Sales\Constraint\CreditmemoRepository');
    }
