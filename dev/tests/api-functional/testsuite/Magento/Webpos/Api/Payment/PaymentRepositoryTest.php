...
namespace Magento\Webpos\Api\Payment;
 ...
 * @package Magento\Webpos\Api\Payment
 */
class PaymentRepositoryTest extends WebapiAbstract
{
    ...
    /**
     * @var \Magento\Webpos\Api\Payment\Constraint\PaymentRepository
     */
    protected $paymentRepository;

    protected function setUp()
    {
        $this->paymentRepository = Bootstrap::getObjectManager()->get('\Magento\Webpos\Api\Payment\Constraint\PaymentRepository');
    }
